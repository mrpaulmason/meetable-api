Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    match 'meetings/:plan_code/view', to: 'meeting#record_view', via: :post
    match 'meetings/:plan_code/share', to: 'meeting#record_share', via: :post
    match 'meetings/:plan_code/time', to: 'meeting#update_availability', via: :post
