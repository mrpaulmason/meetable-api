	...
	def accept
        ...
        if meeting.save
            begin
                ...
                message = Message.new(to: user.phone_number, from: meeting.relay_number, message: "Welcome to Meetable! Use this number to text Paul. Or text PAUSE / STOP anytime. Keep your inbox tidy save this:")
                message.save
